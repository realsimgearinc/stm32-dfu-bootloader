...
make OUTNAME=dfu-srx_sw HSE_SPEED_MHZ=16 LINK_SCRIPT=stm32f103xd.ld \
    USB_VID=0x32b6 USB_PID=0x0800 \
    CONFIG="-DENABLE_GPIO_DFU_BOOT -DGPIO_DFU_BOOT_PORT=GPIOC -DGPIO_DFU_BOOT_PIN=8 -DGPIO_DFU_BOOT_PULLUP -DUSB_PULLUP_PORT=GPIOC -DUSB_PULLUP_PIN=9 -DDFU_USB_MFG_STRING=\"\\\"RealSimGear Inc\\\"\"" \
    clean all
